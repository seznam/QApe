...
describe('Browser', () => {
    ...
    it('can init browser instance', async () => {
        let page = {
            setDefaultNavigationTimeout: jest.fn().mockReturnValue(Promise.resolve()),
        };
        let browserInstance = {
            pages: jest.fn().mockReturnValue(Promise.resolve([page])),
        };
        browser._getBrowser = jest.fn().mockReturnValue(Promise.resolve(browserInstance));
        browser._initPageErrorHandler = jest.fn().mockReturnValue(Promise.resolve());
        ...
        expect(page.setDefaultNavigationTimeout).toHaveBeenCalledWith(defaultNavigationTimeout);
    });
    ...
    it('can initialize page error handler', async () => {
        ...
        let page = {
            ...
            evaluateOnNewDocument: jest.fn().mockReturnValue(Promise.resolve()),
        };
        browser._page = page;
