...
describe('ScenariosHandler', () => {
    ...
    it('can initialize its dependencies', () => {
        ...
        expect(scenariosHandler._scenariosHelper instanceof ScenariosHelper).toBeTruthy();
        expect(scenariosHandler._definedScenarios instanceof DefinedScenarios).toBeTruthy();
        expect(scenariosHandler._failingScenarios instanceof FailingScenarios).toBeTruthy();
        expect(scenariosHandler._randomScenarios instanceof RandomScenarios).toBeTruthy();
    });
