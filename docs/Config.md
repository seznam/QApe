...
# Config
QApe will look for a configuration file at current working directory called `qape.conf.js`.
...
File paths to regression tests generated by QApe file reporter
